...
function drawString()
{
	...
	isSafe = UI.IsHotkeyActive("Rage", "General", "Safe point override");
    ...
    Render.String(screen_size[0] /2 + 1, screen_size[1] /2 +91, 1, isDmgActive ? "DMG": "", isDmgActive ? [ 0, 0, 0, 255 ] : [ 0, 0, 0, 255 ], 3 );
    Render.String(screen_size[0] /2 + 1, screen_size[1] /2 +131, 1, isHideshots ? "HIDE" : "ANIM", isHideshots ? [ 0, 0, 0, 255 ] : [ 0, 0, 0, 255 ], 3 );
    Render.String(screen_size[0] /2 + 1, screen_size[1] /2 +141, 1, isSafe ? "SAFE" : "", isSafe ? [ 0, 0, 0, 255 ] : [ 0, 0, 0, 0 ], 3 );
 Render.String(screen_size[0] /2 + 1, screen_size[1] /2 +151, 1, isFakeduck ? "DUCK" : "", isFakeduck ? [ 0, 0, 0, 255 ] : [ 0, 0, 0, 0 ], 3 );
    ...
    Render.String(screen_size[0] /2, screen_size[1] /2 +90, 1, isDmgActive ? "DMG": "", isDmgActive ? [ 255, 159, 212, 255] : [ 255, 159, 212, 255 ], 3 );
    Render.String(screen_size[0] /2, screen_size[1] /2 +130, 1, isHideshots ? "HIDE" : "ANIM", isHideshots ? [ 145, 120, 229, 255 ] : [ 255, 153, 0, alpha ], 3 );
   Render.String(screen_size[0] /2, screen_size[1] /2 +140, 1, isSafe ? "SAFE" : "", isSafe ? [ 255, 255, 255, 255 ] : [ 0, 0, 0, 0 ], 3 );
