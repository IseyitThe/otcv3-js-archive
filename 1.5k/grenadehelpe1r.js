...
function draw() {
    if (chat_tut && Globals[_0x482c('0x33')]() - chat_start > 0xf) {
        chat_stage = 0x0;
        chat_start = 0x0;
        chat_tut = ![];
        temp_nade = [];
    ...
    UI[_0x482c('0x5c')](_0x482c('0x35'), UI[_0x482c('0x51')]('Script\x20items', _0x482c('0x68')));
    var _0x22384a = Entity[_0x482c('0x3b')](Entity[_0x482c('0x5d')](Entity[_0x482c('0x69')]()));
    if (_0x22384a == _0x482c('0x58')) _0x22384a = _0x482c('0x5f');
    if (!~GRENADE_TYPES[_0x482c('0x19')](_0x22384a)) return;
    if (selection_cache != UI[_0x482c('0x51')]('Script\x20items', _0x482c('0x42')) || (hand_cache != _0x22384a || !~GRENADE_TYPES[_0x482c('0x19')](_0x22384a))) {
        import_grenade_selection();
        map_cache = locations['filter'](function (_0x22658b) {
            return _0x22658b[0x0] == World['GetMapName']() && ~enabled_grenades[_0x482c('0x19')](_0x22658b[0x3]['toLowerCase']()) && _0x22658b[0x3][_0x482c('0x2f')]() == _0x22384a;
        });
    }
    if (map_cache[_0x482c('0x62')] == 0x0) return;
    for (var _0x3ca876 in map_cache) {
        var _0x1b80df = Render[_0x482c('0x1c')]([map_cache[_0x3ca876][0x1][0x0], map_cache[_0x3ca876][0x1][0x1], map_cache[_0x3ca876][0x1][0x2] - 0x3f]);
        if (!map_cache[_0x3ca876][0x7] && !UI[_0x482c('0x51')](_0x482c('0x5'), _0x482c('0xd'))) continue;
        var _0x548e5c = angle_to_vec(map_cache[_0x3ca876][0x2][0x0], map_cache[_0x3ca876][0x2][0x1]);
        var _0x3df22e = map_cache[_0x3ca876][0x1];
        _0x548e5c = Render[_0x482c('0x1c')]([_0x3df22e[0x0] + _0x548e5c[0x0] * 0x190, _0x3df22e[0x1] + _0x548e5c[0x1] * 0x190, _0x3df22e[0x2] + _0x548e5c[0x2] * 0x190]);
        var _0xff469d = calc_dist(Entity['GetRenderOrigin'](Entity[_0x482c('0x69')]()), map_cache[_0x3ca876][0x1]);
        Render[_0x482c('0x4c')](_0x1b80df[0x0], _0x1b80df[0x1], 0x6, [0xff, 0x0, 0x0, 0xc8]);
        Render[_0x482c('0x4c')](_0x1b80df[0x0], _0x1b80df[0x1], 0x1, [0xff, 0xff, 0xff, 0xc8]);
        var _0xcfd075 = Render['TextSize'](map_cache[_0x3ca876][0x4], 0x8);
        var _0x508347 = Render[_0x482c('0x1b')](map_cache[_0x3ca876][0x5], 0x8);
        Render['FilledRect'](_0x1b80df[0x0] + 0x9, _0x1b80df[0x1] - _0xcfd075[0x1] / 1.5, _0xcfd075[0x0] + 0x7, _0xcfd075[0x1] + 0x4, [0x2d, 0x2b, 0x30, 0xff]);
        Render[_0x482c('0x52')](_0x1b80df[0x0] + 0xa, _0x1b80df[0x1] - _0xcfd075[0x1] / 1.5, _0xcfd075[0x0] + 0x5, 0x2, 0x1, [0x7c, 0x15, 0x15, 0xff], [0xb8, 0x1f, 0x1f, 0xff]);
        shadow(_0x1b80df[0x0] + 12.5, _0x1b80df[0x1] - 0x5, 0x0, map_cache[_0x3ca876][0x4], ![], undefined, [0xff, 0xff, 0xff, 0xff], 0x8);
        if (_0xff469d > 0x46) continue;
        Render['Circle'](_0x548e5c[0x0], _0x548e5c[0x1], 0x1, [0xff, 0xff, 0xff, 0xc8]);
        Render[_0x482c('0x17')](_0x548e5c[0x0] + 0xa, _0x548e5c[0x1] - _0xcfd075[0x1] / 1.5, _0xcfd075[0x0] > _0x508347[0x0] ? _0xcfd075[0x0] + 0x5 : _0x508347[0x0] + 0x5, _0xcfd075[0x1] > _0x508347[0x1] ? _0xcfd075[0x1] + 0xf : _0x508347[0x1] + 0xf, [0x2d, 0x2b, 0x30, 0xff]);
        Render[_0x482c('0x52')](_0x548e5c[0x0] + 0xa, _0x548e5c[0x1] - _0xcfd075[0x1] / 1.5, _0xcfd075[0x0] > _0x508347[0x0] ? _0xcfd075[0x0] + 0x5 : _0x508347[0x0] + 0x6, 0x2, 0x1, [0x7c, 0x15, 0x15, 0xff], [0xb8, 0x1f, 0x1f, 0xff]);
        shadow(_0x548e5c[0x0] + 12.5, _0x548e5c[0x1] - 0x5, 0x0, map_cache[_0x3ca876][0x4], ![], undefined, [0xff, 0xff, 0xff, 0xff], 0x8);
        shadow(_0x548e5c[0x0] + 12.5, _0x548e5c[0x1] + 6.5, 0x0, map_cache[_0x3ca876][0x5], ![], undefined, [0xff, 0xff, 0xff, 0xff], 0x8);
        Render['Circle'](_0x548e5c[0x0], _0x548e5c[0x1], 0x6, [0x38, 0xc8, 0x38, 0xff]);
        Render[_0x482c('0x14')](Render[_0x482c('0x39')]()[0x0] / 0x2, Render[_0x482c('0x39')]()[0x1] / 0x2, _0x548e5c[0x0], _0x548e5c[0x1], [0xb8, 0x1f, 0x1f, 0xff]);
    }
}
