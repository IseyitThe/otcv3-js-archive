...
function isNative(_0xf303x2c) {
    return (/\{\s*\[native code\]\s*\}/)['test']('' + _0xf303x2c)
}
var switch_ = false;
...
function hitlog() {
    ...
    if (me == attackerIndex && me != victimIndex) {
        ...
        Cheat.PrintColor([238, 143, 36, 255], 'WIZARD');
        Cheat.PrintColor([198, 198, 198, 255], 'XL');
        Cheat.PrintColor([255, 255, 255, 255], ']');
        ...
        if (_0xf303x8e == 'Hit ') {
            if (UI.GetValue('Script items', 'Enable chat logging')) {
                Cheat.PrintChat(' \x01[\x10STAR\x08CORD\x01][\x04' + shots.toString() + '\x08] ' + _0xf303x8e + name + '\'s 	' + HitgroupName(hitbox) + '\x08 for \x02' + target_damage.toString() + '\x08 (\x06' + target_health.toString() + '\x08 remaining) aimed=\x02' + hitboxName + '\x08(' + predicthc.toString() + '%%)\x08 (\x10' + _0xf303x90 + '\x08) (\x10' + _0xf303x8f + '\x08:\x10' + exploit + '\x08)\x0A')
            };
