...
function HUD_REDRAW()
{
    ...
    if(loadFont == 0)
    {
        font = Render.AddFont("Josefin Sans Bold", 8, 100)
        fontSmall = Render.AddFont("Josefin Sans Bold", 6, 100)
        fontNormal = Render.AddFont("Josefin Sans Bold", 7, 100)
        loadFont = 1;
    }
     
    var watermark_font = Render.AddFont("Josefin Sans Bold", 8, 100)
    ...
    var width = 50
    //grey all
    Render.FilledRect( 1214, 8, 217, 32, [ 23, 18, 50, 255 ] );
   
    //main
    Render.FilledRect(1220, 15, 205, 19, [ 33, 26, 68, 255 ] ); // black
 
    //white
    Render.Rect(1220, 13, 206, 21, [ 46, 40, 76, 255 ] ); // white
    width = 93
    Render.GradientRect(1221, 15, 102, 1, 1, [175, 35, 100 ,255], [75, 14, 50 ,255]);
    Render.GradientRect(1323, 15, 102, 1, 1,[75, 14, 50 ,255], [56, 44, 116, 255]);
    
    const ping = Math.floor(Global.Latency() * 1000 / 9.3);
    ...
    Render.StringCustom(1234, 14, 1, "one", [ 255, 255, 255,255 ], watermark_font);
    Render.StringCustom(1253, 14, 1, "tap", [ 175, 35, 100 ,255 ], watermark_font);
    Render.StringCustom(1267, 14, 1, "|", [ 255, 255, 255 ,255 ], watermark_font);
    Render.StringCustom(1285, 14, 1, "Mae", [ 255, 255, 255 ,255 ], watermark_font);
    Render.StringCustom(1302, 14, 1, "|", [ 255, 255, 255 ,255 ], watermark_font);
    Render.StringCustom(1337, 14, 1, "|", [ 255, 255, 255 ,255 ], watermark_font);
    Render.StringCustom(1312, 14, 1, ping +"", [ 255, 255, 255, 255 ], watermark_font);
    Render.StringCustom(1325, 14, 1, "ms", [ 175, 35, 100 ,255 ], watermark_font);
    Render.StringCustom(1350, 14, 1, fps +"", [ 255, 255, 255, 255 ], watermark_font);
    Render.StringCustom(1369, 14, 1, "fps", [ 175, 35, 100 ,255 ], watermark_font);
    Render.StringCustom(1382, 14, 1, "|", [ 255, 255, 255 ,255 ], watermark_font);
    Render.StringCustom(1405, 14, 1, "" + datetime, [ 255, 255, 255,255 ], watermark_font);
