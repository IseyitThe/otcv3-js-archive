...
var x = UI.GetValue("Script items","Indicator X");
var y = UI.GetValue("Script items","Indicator Y");
if(UI.IsHotkeyActive("Script items","Override Hotkey")) {
Render.StringCustom(x,y,1,"HITBOX OVERRIDE",[128,182,0,255],font);
Render.StringCustom(x+1,y,1,"HITBOX OVERRIDE",[45,45,45,84],font); }
/*else {
Render.String(961,571,1,"HITBOX OVERRIDE",[200,2,0,255],1);
//}*/
}
