...
function main_dt() {
    ...
    var font = Render.AddFont("Segoe", 8, 300);
    var fontbullet = Render.AddFont("Segoe", 18, 300);
    if (CanShoot && Exploit.GetCharge() == 1 && UI.IsHotkeyActive("Rage", "Exploits", "Doubletap")) {
        var text = "Shift Charge | Shift: Ready";
        var color = [89, 119, 239, 255];
    } 
    else if (CanShoot && Exploit.GetCharge() == 1 && UI.IsHotkeyActive("Rage", "Exploits", "Hide shots")) {
        var text = "Shift Charge | Shift: Usable";
        var color = [89, 119, 239, 255];
    } 
    else if ((g_Local_classname == "CKnife" || g_Local_classname == "CWeaponSSG08" || g_Local_classname == "CWeaponAWP" || weapon_name == "r8 revolver" || g_Local_classname == "CHEGrenade" || g_Local_classname == "CMolotovGrenade" || g_Local_classname == "CIncendiaryGrenade" || g_Local_classname == "CFlashbang" || g_Local_classname == "CSmokeGrenade" || g_Local_classname == "CDecoyGrenade" || g_Local_classname == "CWeaponTaser" || g_Local_classname == "CC4")) {
        var text = "Shift Charge | Shift: Not Usable";
        var color = [89, 119, 239, 255];
    }
    else {
        var text = "Shift Charge | Shift: Not Ready";
        var color = [89, 89, 89, 255];
    }
    var w = Render.TextSizeCustom(text, font)[0] + 8;

    Render.FilledRect(x, y, w, 2, [217, 157, 86, 255]);
    ...
    if ((g_Local_classname == "CKnife" || g_Local_classname == "CWeaponSSG08" || g_Local_classname == "CWeaponAWP" || weapon_name == "r8 revolver" || g_Local_classname == "CHEGrenade" || g_Local_classname == "CMolotovGrenade" || g_Local_classname == "CIncendiaryGrenade" || g_Local_classname == "CFlashbang" || g_Local_classname == "CSmokeGrenade" || g_Local_classname == "CDecoyGrenade" || g_Local_classname == "CWeaponTaser" || g_Local_classname == "CC4")) {
        Render.StringCustom(x + 15 + Render.TextSize(get_icon(weapon_name), 5)[0], y + 18, 0, "CANT USE", [217, 157, 86, 255], fontbullet);
    } else 
    {
        ...
        if (CanShoot && Exploit.GetCharge() == 1 && UI.IsHotkeyActive("Rage", "Exploits", "Doubletap")) 
        {
            ...
            Render.StringCustom(x + 15 + Render.TextSize(get_icon(weapon_name), 5)[0], y + 18, 0, "READY", [217, 157, 86, sa * 255], fontbullet);
        } 
        else 
        {
            sa = 0;
