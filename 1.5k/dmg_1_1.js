...
function indicator()
{
	...
	{
        isDoubletap = false;
		Render.String(10, y + 164, 0, "DUCK", [10, 10, 10, 125], 4);
		Render.String(9 , y +165, 0, "DUCK", [255, 255, 255, 200], 4);
    }
    ...
    Render.String(13, 960, 0, str+"", [10, 10, 10, 125],4);
    Render.String(11, 959, 0, str+"", [255,255,255,255],4)
}
