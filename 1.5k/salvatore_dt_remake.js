...
UI.AddSliderInt("Double tap Recharge speed", -2, 14);
...
function can_shift_shot(ticks_to_shift) {
    ...
    var tickbase = Entity.GetProp(me, "CCSPlayer", "m_nTickBase") + UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Double tap Recharge speed");
...
function _TBC_CREATE_MOVE() {
    ...
    Exploit.OverrideTolerance(reserve / 2);
    Exploit.OverrideShift(14 - ( reserve / 2 ));
}
