...
function clantag() {
	var clantag = UI.GetValue("MISC", "JAVASCRIPT", "Script items", "ClanTag");
	if(clantag == 1)
	{
...
UI.AddDropdown( "ClanTag", [ "off", "gamesense", "NeverDea", "skeet.cc", "phack", "eexomi.host", "memesense", "katanaware", Cheat.GetUsername(), "nerox.su", "TrapSync" ] );
