...
function initializeMenuItems() {
    ...
    UI.AddLabel("Version: 1.2 PREMIUM");
    ...
    UI.AddDropdown("Font", ["Bold", "Normal"]);
...
function onCreateMove() {
	if(!jsLoaded)return;
    othersUpdate();
    if (Globals.Tickcount() % 6 == 0 || onShotFire>0) antiAimUpdate(getValue("Premium Anti-Aim"));
...
function setLegitAA(invert) {
    ...
    if (invert) {
        ...
        if (getValue("Jitter Real")) {
            realOffset = -getRandomInteger(10, 60);
    ...
    if (UI.IsHotkeyActive("Anti-Aim", "Extra", "Slow walk") && getValue("Slow Walk")) {
        if (slowWalkInitialized > 4) {
            ...
            slowWalkRealOffset = getRandomInteger(10, 40);
            slowWalkLBYOffset = getRandomInteger(60, 90);
        } else {
            slowWalkInitialized++;
        }
    ...
    if (UI.IsHotkeyActive("Anti-Aim", "Extra", "Slow walk") && getValue("Slow Walk")) {
        if (slowWalkInitialized > 4) {
            ...
            if (getValue("Slow Walk Mode") == 0) {
                slowWalkRealOffset = getRandomInteger(20, 25);
                slowWalkFakeOffset = -getRandomInteger(20, 25);
                slowWalkLBYOffset = getRandomInteger(30, 60);
                slowWalkJitterOffset = getRandomInteger(8, 10);
            } else if (getValue("Slow Walk Mode") == 1) {
                slowWalkRealOffset = getRandomInteger(10, 15);
                slowWalkFakeOffset = -getRandomInteger(10, 15);
                slowWalkLBYOffset = getRandomInteger(15, 25);
...
function drawAllKeybinds() {
    ...
    for (i = 0; i < keybinds.length; i++) {
        Render.String(x4, y4, 1, keybinds[i], getColor("UI Color"), 16);
        y4 += 25;
    }
}
...
function drawHitAndMiss() {
    ...
    Render.String(getValue("x3") + 15, getValue("y3") + 35, 0, "Weapon: " + Entity.GetName(Entity.GetWeapon(Entity.GetLocalPlayer())) + " shot: " + shot[Entity.GetName(Entity.GetWeapon(Entity.GetLocalPlayer()))] + " hit: " + hit[Entity.GetName(Entity.GetWeapon(Entity.GetLocalPlayer()))], theme_text, font_size);
    Render.String(getValue("x3") + 15, getValue("y3") + 55, 0, "Current " + (percentage * 100).toFixed(0) + "%", theme_text, font_size);
    ...
    Render.String(getValue("x3") + 15, getValue("y3") + 75, 0, "Total " + (percentageSum * 100).toFixed(0) + "%", theme_text, font_size);
...
function drawDamageGiven() {
    ...
    Render.String(getValue("x5") + 15, getValue("y5") + 35, 0, "Target", theme_text, font_size);
    Render.String(getValue("x5") + 70, getValue("y5") + 35, 0, "Weapon", theme_text, font_size);
    Render.String(getValue("x5") + 135, getValue("y5") + 35, 0, "Damage", theme_text, font_size);
    Render.String(getValue("x5") + 195, getValue("y5") + 35, 0, "Hitbox", theme_text, font_size);

    if (damageList.length == 0) return;
    x = 0;
    for (i = damageList.length - 1; i > damageList.length - 6; i--) {
        if (i < 0) break;
        Render.String(getValue("x5") + 15, getValue("y5") + 55 + (20 * x), 0, damageList[i]["target"].toString(), theme_text, font_size);
        Render.String(getValue("x5") + 70, getValue("y5") + 55 + (20 * x), 0, damageList[i]["weapon"].toString(), theme_text, 5);
        Render.String(getValue("x5") + 160, getValue("y5") + 55 + (20 * x), 1, damageList[i]["damage"].toString(), theme_text, font_size);
        Render.String(getValue("x5") + 195, getValue("y5") + 55 + (20 * x), 0, damageList[i]["hitbox"].toString(), theme_text, font_size);
        x++;
    }
}
...
function drawStatusIndicator() {
        ...
        Render.String(getValue("x2") + 60, getValue("y2") + 35, 0, "Current Target: " + targetName, theme_text, font_size);
        Render.String(getValue("x2") + 60, getValue("y2") + 55, 0, "Head Scale ", theme_text, font_size);
        ...
        Render.String(getValue("x2") + 60, getValue("y2") + 75, 0, "Body Scale ", theme_text, font_size);
        ...
        Render.String(getValue("x2") + 60, getValue("y2") + 95, 0, "Damage Mode: " + damageMode, theme_text, font_size);
        Render.String(getValue("x2") + 60, getValue("y2") + 115, 0, "Expected Damage: " + expectedDamage + "HP", theme_text, font_size);
        Render.String(getValue("x2") + 60, getValue("y2") + 135, 0, "Dodge Bruteforce: " + dodgeBruteforce, theme_text, font_size);
        Render.String(getValue("x2") + 60, getValue("y2") + 155, 0, "Desync ", theme_text, font_size);
        ...
        Render.String(getValue("x2") + 60, getValue("y2") + 175, 0, "Fake Lag ", theme_text, font_size);
        ...
        Render.String(getValue("x2") + 60, getValue("y2") + 195, 0, "Rage FOV ", theme_text, font_size);
        ...
        Render.String(getValue("x2") + 60, getValue("y2") + 215, 0, "Accuracy ", theme_text, font_size);
...
function specialOnDraw(){
    ...
    Render.String(getValue("xxx") + 15, getValue("yyy") + 33, 0, "Damage Mode: " + damageMode, theme_text, font_size);
    Render.String(getValue("xxx") + 15, getValue("yyy") + 53, 0, "Expected Damage: " + expectedDamage + "HP", theme_text, font_size);
    Render.String(getValue("xxx") + 15, getValue("yyy") + 73, 0, "Dodge Bruteforce: " + dodgeBruteforce, theme_text, font_size);
    Render.String(getValue("xxx") + 15, getValue("yyy") + 93, 0, "Desync ", theme_text, font_size);
    ...
    Render.String(getValue("xxx") + 15, getValue("yyy") + 113, 0, "Fake Lag ", theme_text, font_size);
	...
	if(UI.IsHotkeyActive("Rage","GENERAL","General","Enabled")){
		Render.String(getValue("xxx") + 70, getValue("yyy") + 185, 1, ">>Aimbot<<", activeColor, font_size);
	}else{
		Render.String(getValue("xxx") + 70, getValue("yyy") + 185, 1, "Aimbot", theme_text, font_size);
	}
	if(getValue("Auto Wall Mode")!=0 || getValue("Play Style")==2){
		if(getValue("Auto Wall Mode")==1 && getValue("Play Style")==1){
			Render.String(getValue("xxx") + 180, getValue("yyy") + 135, 1, ">>Legit AW<<", activeColor, font_size);
		}else{
			Render.String(getValue("xxx") + 180, getValue("yyy") + 135, 1, ">>Rage AW<<", activeColor, font_size);
		}
	}else{
		Render.String(getValue("xxx") + 180, getValue("yyy") + 135, 1, "Auto Wall", theme_text, font_size);
	}
	if(getHotkey("Fake Duck")){
		Render.String(getValue("xxx") + 70, getValue("yyy") + 160, 1, ">>Fake Duck<<", activeColor, font_size);
	}else{
		Render.String(getValue("xxx") + 70, getValue("yyy") + 160, 1, "Fake Duck", theme_text, font_size);
	}
	if(UI.IsHotkeyActive("Anti-Aim", "Extra", "Slow walk")){
		Render.String(getValue("xxx") + 180, getValue("yyy") + 160, 1, ">>Slow Walk<<", activeColor, font_size);
	}else{
		Render.String(getValue("xxx") + 180, getValue("yyy") + 160, 1, "Slow Walk", theme_text, font_size);
	}
	if(getValue("Dynamic FOV") && getValue("Play Style")==1){
		Render.String(getValue("xxx") + 70, getValue("yyy") + 135, 1, "FOV "+UI.GetValue("Rage", currentWeapon.toUpperCase(), "Targeting", "FOV")+"", [255,165,0,255], font_size);
	}else{
		Render.String(getValue("xxx") + 70, getValue("yyy") + 135, 1, "FOV "+UI.GetValue("Rage", currentWeapon.toUpperCase(), "Targeting", "FOV"), theme_text, font_size);
	}
	if(UI.IsHotkeyActive("Rage","GENERAL","General","Force body aim")){
		Render.String(getValue("xxx") + 180, getValue("yyy") + 185, 1, ">>Body Aim<<", activeColor, font_size);
	}else{
		Render.String(getValue("xxx") + 180, getValue("yyy") + 185, 1, "Body Aim", theme_text, font_size);
	}
}
}
