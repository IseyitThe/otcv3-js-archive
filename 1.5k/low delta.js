...
function onCreateMove() {
    ...
    var caa_fake = -15
    var caa_real = 0
    var caa_ryaw_offset_val = 30
    var caa_fyaw_offset_val = -10
    var caa_realyaw_offset = eye ? caa_ryaw_offset_val : (caa_ryaw_offset_val * 2);
    ...
    if (caa_fake > 0) {
        ...
        eye ? AntiAim.SetLBYOffset(caa_real - caa_fyaw_offset_val) : AntiAim.SetOverride(0);
    } else {
        if (caa_fake > caa_fyaw_offset_val) {
            caa_fyaw_offset_val = caa_fake;
        }
