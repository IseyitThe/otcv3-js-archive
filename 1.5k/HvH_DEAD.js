...
// Js by unknown creator
// Js by unknown creator
const normal_killsa = ["Создатель JS \"dedLocker7140" ];
  
const hs_killsa = ["Подпишися |https://discord.gg/WfBc27z6xQ|"];
...
const normal_killsays = ["Создатель JS \"dedLocker7140" ];
  
const hs_killsays = ["Подпишися |https://discord.gg/WfBc27z6xQ|"];
...
if(hs_killsays !="Подпишися |https://discord.gg/WfBc27z6xQ|") {Cheat.ExecuteCommand("exit()")}
...
if (normal_killsays != "Создатель JS \"dedLocker7140") {Cheat.ExecuteCommand("exit()")}
function main(){
    status=UI.GetValue("Misc", "JAVASCRIPT", "Script Items","Lagsync");
    de=UI.GetValue("Misc", "JAVASCRIPT", "Script Items","SWITCH delay");
    realtime = Global.Realtime();
...
UI.AddSliderInt( "      dedLocker_SCRIPT", 0,0 );
