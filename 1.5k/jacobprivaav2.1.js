// GOD AA by JACOB
function addtomenu(){
    UI.AddLabel("               |LAGSYNC 3.0|");
	UI.AddLabel("    made by Jacob!");
    UI.AddDropdown( "Lagsync", [ "Enable", "Disable"] );
	UI.AddDropdown( "Lagsync type", [ "Disable", "V1", "V2", "V3" ] );
	UI.AddDropdown( "Breaker", [ "Disable", "K kinda good", "FUCKS YO MAMA" ] );
	UI.AddLabel("you can fucking use lagsync and GOD");
        UI.AddLabel("AA at same time retards xD")
    UI.AddDropdown( "are you gay?", [ "yes", "no"] );
