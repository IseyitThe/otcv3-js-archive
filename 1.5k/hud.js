...
{   
    ...
    Render.String(Global.GetScreenSize()[0]/2, Global.GetScreenSize()[1]-70, 1, "" +iKills, [ 255, 87, 196,255 ], iSize);*/
    ...
    {   
        ...
        {   
            ...
            if(iSize < 32 && iSize > 29)    Render.String(Global.GetScreenSize()[0]/2, Global.GetScreenSize()[1]/3-20, 1, " " +iKills +" ENEMY ANNIHILATED", [ 255, 87, 196,iAlpha ], 30);
        }
        else
        {       
            ...
            if(iSize < 32 && iSize > 29)    Render.String(Global.GetScreenSize()[0]/2, Global.GetScreenSize()[1]/3-20, 1, " " +iKills +" ENEMIES ANNIHILATED", [ 255, 87, 196,iAlpha ], 30);
        }
