...
function HUD_REDRAW()
{
    ...
    {
        font = Render.AddFont("Verdana Bold", 16, 800);
           const fontpixel = Render.AddFont( "Verdana Bold", 7, 1600);
        ...
        if(UI.IsHotkeyActive("Rage", "GENERAL", "Exploits", "Doubletap"))
        {
            ...
            {
                Render.StringCustom(Global.GetScreenSize()[0]/49+UI.GetValue(Xoffset), Global.GetScreenSize()[1]-349+UI.GetValue(Yoffset), 1, "DT", [ 0, 0, 0, 255 ], font);  
                Render.StringCustom(Global.GetScreenSize()[0]/50+UI.GetValue(Xoffset), Global.GetScreenSize()[1]-350+UI.GetValue(Yoffset), 1, "DT", [ 130, 190, 35, 255 ], font);  
