...
function setup1() {
    ...
    UI['AddLabel']('-------------------------------------'), UI['AddLabel']('                exscord.js'), UI['AddLabel']('For support contact: mett#6226'), UI['AddLabel'](_0x394796('0x3c')), UI['AddLabel']('-------------------------------------'), UI['AddLabel']('         Anti-aim and indicators            '), Cheat['Print']('exscord.js finished setup. U are verified.');
}
