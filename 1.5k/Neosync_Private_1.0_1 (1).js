var _0x2d2d = ['GetScreenSize', 'IsHotkeyActive', 'Misc', 'Script items', 'JAVASCRIPT', 'push', 'sharkhvh', 'SCOUT', 'GetValue', 'Rage', 'Minimum damage', 'AUTOSNIPER', 'Rage Anti-Aim', 'indexOf', 'GetUsername', 'Anti-Aim', 'Yaw offset', 'Jitter offset', 'SetRealOffset', 'SetOverride', 'toUpperCase', 'Exploits', 'g3sg1', 'CFlashbang', 'CSmokeGrenade', 'CDecoyGrenade', 'Fake angles', 'AWP', 'ssg 08', 'Line', 'abs', 'toFixed', 'min', 'GetFakeYaw', 'Selected arrow color', 'GetColor', '[NeoSync] Freestanding', 'GetClassName', 'NEOSYNC', 'SetValue', '[NeoSync] Hide real', 'DYNAMIC', 'FREESTAND', 'StringCustom', 'DEFAULT', 'dual berettas', 'usp s', 'CHEGrenade', 'CIncendiaryGrenade', 'CC4', 'DT (onshot)', 'DT (active weapon)', 'DMG', 'SAFE', 'HEAD', 'Backwards Hotkey', 'Tickcount', 'CWeaponAWP', 'GENERAL', 'Force safe point', '          Last update: 19/09/20', 'Left Hotkey', 'AddHotkey', 'AddColorPicker', 'AddCheckbox', '[NeoSync] Safe AWP', 'Minimum damage override', 'AddSliderInt', 'CreateMove', 'Safe_Head'];
...
protectnames[_0x3a0e6d('0x5')](username);
...
if (protectnames[_0x3a0e6d('0xd')](Cheat['GetUsername']()) !== -0x1) {
    function Safe_Head() {
        ...
        localplayer_index = Entity['GetLocalPlayer'](), protectnames['indexOf'](Cheat[_0x22da9b('0xe')]()) !== -0x1 && (UI['GetValue']('Misc', 'JAVASCRIPT', _0x22da9b('0x3'), '[NeoSync] Dodge AA Mode') && UI['IsHotkeyActive'](_0x22da9b('0xf'), 'Extra', 'Slow walk') ? (UI['SetValue']('Anti-Aim', 'Rage Anti-Aim', _0x22da9b('0x10'), 0xa), UI['SetValue']('Anti-Aim', 'Rage Anti-Aim', _0x22da9b('0x11'), 0x0), AntiAim['SetOverride'](0x1), AntiAim['SetFakeOffset'](0x0), AntiAim[_0x22da9b('0x12')](-0x1e)) : (UI['SetValue'](_0x22da9b('0xf'), _0x22da9b('0xc'), 'Jitter offset', jitter_cache), AntiAim[_0x22da9b('0x13')](0x0)));
    }
}
...
function delay_shot() {
    ...
    if (!isActive('[NeoSync] Delay shot')) {
...
function safeAWP() {
    ...
    if (UI['GetValue']('Misc', 'JAVASCRIPT', 'Script items', '[NeoSync] Safe AWP') && localplayer_classname == _0x539183('0x39')) is_force_safe_point = UI['IsHotkeyActive']('Rage', 'GENERAL', 'General', 'Force safe point'), !is_force_safe_point && (UI['ToggleHotkey'](_0x539183('0x9'), _0x539183('0x3a'), 'General', _0x539183('0x3b')), prefer_safe_backup = !![]);
    else prefer_safe_backup && (UI['ToggleHotkey']('Rage', 'GENERAL', 'General', 'Force safe point'), prefer_safe_backup = ![]);
}

function setup1() {
    var _0x394796 = _0x3a0e6d;
    UI['AddLabel']('-------------------------------------'), UI['AddLabel']('                NeoSync.js'), UI['AddLabel']('        youtube.com/neosync'), UI['AddLabel'](_0x394796('0x3c')), UI['AddLabel']('-------------------------------------'), UI['AddLabel']('         Anti-aim and indicators            '), Cheat['Print']('NeoSync.js finished setup.');
}
...
function Main() {
    ...
    protectnames['indexOf'](Cheat['GetUsername']()) !== -0x1 && (setup1(), UI['AddHotkey']('[NeoSync] Freestanding'), UI['AddHotkey'](_0x59c8b1('0x3d')), UI[_0x59c8b1('0x3e')]('Right Hotkey'), UI[_0x59c8b1('0x3e')]('Backwards Hotkey'), UI['AddHotkey']('Forwards Hotkey'), UI['AddColorPicker']('Selected arrow color'), UI[_0x59c8b1('0x3f')]('Arrow color'), UI['AddHotkey']('[NeoSync] Hide real'), UI['AddCheckbox']('[NeoSync] Dodge AA Mode'), setup2(), UI[_0x59c8b1('0x40')](_0x59c8b1('0x41')), UI['AddHotkey']('[NeoSync] Delay shot'), UI['AddHotkey'](_0x59c8b1('0x42')), UI[_0x59c8b1('0x43')]('Heavy Pistol Mindmg', 0x0, 0x82), UI['AddSliderInt']('Scout Mindmg', 0x0, 0x82), UI['AddSliderInt']('AWP Mindmg', 0x0, 0x82), UI[_0x59c8b1('0x43')]('Auto Mindmg', 0x0, 0x82), Global['RegisterCallback']('Draw', 'drawString'), Global['RegisterCallback']('CreateMove', 'onCreateMove'), Cheat['RegisterCallback'](_0x59c8b1('0x44'), _0x59c8b1('0x45')));
}
