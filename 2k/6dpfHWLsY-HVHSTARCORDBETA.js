...
var aa_state = 'DEFAULT';
var aa_state2 = 'HIDE-SHOT';
var aa_color = [255, 0, 0, 255];
var aa_color2 = [170, 170, 170, 255];
...
function indicators() {
    ...
    if (CanUse3 && UI.GetValue('Script items', 'Enable Indicators') == 1 && UI.GetValue('Script items', 'Enable AntiAim & Indicators') == 1) {
        ...
        var _0xf303x48 = Render.TextSize('HVHSTARCORD', 7);
        var _0xf303x49 = Render.TextSize(aa_state, 7);
        var _0xf303x4a = Render.TextSize(aa_state2, 7);
        var _0xf303x4b = Render.TextSize('DOUBLE-TAP', 7);
        var _0xf303x4c = Render.TextSize('BAIM', 7);
        var _0xf303x4d = Render.TextSize('SAFE', 7);
        var _0xf303x4e = Render.TextSize('DUCK', 7);
        ...
        Render.String(screen_size[0] / 2 - _0xf303x48[0] / 2 + 2, screen_size[1] / 2 + 80 + _0xf303x48[1] / 2 + 2, 0, 'HVHSTARCORD', [255, 236, 236, _0xf303x41], 7);
        Render.String(screen_size[0] / 2 - _0xf303x48[0] / 2 + 1, screen_size[1] / 2 + 80 + _0xf303x48[1] / 2 + 1, 0, 'HVHSTARCORD', [255, 236, 236, _0xf303x40], 7);
        Render.String(screen_size[0] / 2 - _0xf303x48[0] / 2, screen_size[1] / 2 + 80 + _0xf303x48[1] / 2, 0, 'HVHSTARCORD', [255, 236, 236, _0xf303x3f], 7);
        ...
        Render.String(screen_size[0] / 2 - _0xf303x4b[0] / 2 + 2, screen_size[1] / 2 + 120 + _0xf303x4b[1] / 2 + 2, 0, 'DOUBLE-TAP', _0xf303x42 ? _0xf303x43 == 1 ? [128, 255, 0, 55] : [255, 0, 0, _0xf303x41] : [255, 0, 0, _0xf303x41], 7);
        Render.String(screen_size[0] / 2 - _0xf303x4b[0] / 2 + 1, screen_size[1] / 2 + 120 + _0xf303x4b[1] / 2 + 1, 0, 'DOUBLE-TAP', _0xf303x42 ? _0xf303x43 == 1 ? [128, 255, 0, 155] : [255, 0, 0, _0xf303x40] : [255, 0, 0, _0xf303x40], 7);
        Render.String(screen_size[0] / 2 - _0xf303x4b[0] / 2, screen_size[1] / 2 + 120 + _0xf303x4b[1] / 2, 0, 'DOUBLE-TAP', _0xf303x42 ? _0xf303x43 == 1 ? [128, 255, 0, 255] : [255, 0, 0, _0xf303x3f] : [255, 0, 0, _0xf303x3f], 7);
        ...
        Render.String(screen_size[0] / 2 - _0xf303x4c[0] / 2 + 2, screen_size[1] / 2 + 160 + _0xf303x4c[1] / 2 + 2, 0, 'BAIM', _0xf303x45 ? [128, 255, 0, 55] : [150, 150, 150, 55], 7);
        Render.String(screen_size[0] / 2 - _0xf303x4c[0] / 2 + 1, screen_size[1] / 2 + 160 + _0xf303x4c[1] / 2 + 1, 0, 'BAIM', _0xf303x45 ? [128, 255, 0, 155] : [150, 150, 150, 155], 7);
        Render.String(screen_size[0] / 2 - _0xf303x4c[0] / 2, screen_size[1] / 2 + 160 + _0xf303x4c[1] / 2, 0, 'BAIM', _0xf303x45 ? [128, 255, 0, 255] : [150, 150, 150, 255], 7);
        Render.String(screen_size[0] / 2 - _0xf303x4e[0] / 2 + 2, screen_size[1] / 2 + 180 + _0xf303x4e[1] / 2 + 2, 0, 'DUCK', _0xf303x46 ? [128, 255, 0, 55] : [150, 150, 150, 55], 7);
        Render.String(screen_size[0] / 2 - _0xf303x4e[0] / 2 + 1, screen_size[1] / 2 + 180 + _0xf303x4e[1] / 2 + 1, 0, 'DUCK', _0xf303x46 ? [128, 255, 0, 155] : [150, 150, 150, 155], 7);
        Render.String(screen_size[0] / 2 - _0xf303x4e[0] / 2, screen_size[1] / 2 + 180 + _0xf303x4e[1] / 2, 0, 'DUCK', _0xf303x46 ? [128, 255, 0, 255] : [150, 150, 150, 255], 7);
...
function watermark() {
    ...
    var _0xf303x5d = 'Gamesense.pub [By Diogo] | ' + Cheat.GetUsername() + ' | delay: ' + _0xf303x5b + 'ms | ' + _0xf303x5a + 'tick | ' + _0xf303x57 + _0xf303x58 + _0xf303x59;
...
function authorization() {
    ...
    if (state >= 1) {
        ...
        Render.StringCustom((screen_size[0] / 2) - (width / 2) + 80, y + 9, 0, 'hello im shirazu', [255, 255, 255, alpha], font);
    ...
    if (state >= 2 && state < 4) {
        ...
        Render.StringCustom((screen_size[0] / 2) - 90, y1 + 9, 0, 'im 14 yo russian bot', [255, 255, 255, alpha1], font);
    ...
    if (state >= 3 && state < 7) {
        ...
        Render.StringCustom((screen_size[0] / 2) - 120, y2 + 9, 0, '100 kg bodypositive)', [255, 255, 255, alpha2], font);
    ...
    if (state >= 4 && _0xf303x62 && state <= 5) {
        ...
        Render.StringCustom((screen_size[0] / 2) - 205, y3 + 9, 0, ' Successfully loaded: Miss Logger | [v1.0] [beta] | Last Update August 29 2020 22:07:30', [255, 255, 255, alpha3], font);
        Render.String((screen_size[0] / 2) - 255, y3 + 8, 0, '!', [255, 255, 255, alpha3], 5)
    };
    if (state >= 5 && state < 1231 && _0xf303x62) {
        font = Render.AddFont('Verdana', 7, 800);
        Render.FilledRect((screen_size[0] / 2) - 275, y5, 550, 30, [0, 0, 0, alpha5_b]);
        Render.GradientRect((screen_size[0] / 2) - 275, y5 - 3, 550, 3, 0, [104, 106, 128, alpha5], [5, 30, 110, alpha5]);
        Render.StringCustom((screen_size[0] / 2) - 225, y5 + 9, 0, '[+]', [46, 246, 53, alpha5], font);
        Render.StringCustom((screen_size[0] / 2) - 205, y5 + 9, 0, ' Successfully loaded: Watermark | [v1.0] [beta] | Last Update August 29 2020 21:59:30', [255, 255, 255, alpha5], font);
        Render.String((screen_size[0] / 2) - 255, y5 + 8, 0, '!', [255, 255, 255, alpha5], 5)
    };
    if (state >= 6 && state < 853443 && _0xf303x62) {
        font = Render.AddFont('Verdana', 7, 800);
        Render.FilledRect((screen_size[0] / 2) - 285, y6, 570, 30, [0, 0, 0, alpha6_b]);
        Render.GradientRect((screen_size[0] / 2) - 285, y6 - 3, 570, 3, 0, [104, 106, 128, alpha6], [5, 30, 110, alpha6]);
        Render.StringCustom((screen_size[0] / 2) - 235, y6 + 9, 0, '[+]', [46, 246, 53, alpha6], font);
        Render.StringCustom((screen_size[0] / 2) - 215, y6 + 9, 0, ' Successfully loaded: AntiAim & Indicators | [v1.0] [beta] | Last Update August 29 2020 22:07:30', [255, 255, 255, alpha6], font);
        Render.String((screen_size[0] / 2) - 265, y6 + 8, 0, '!', [255, 255, 255, alpha6], 5)
    };
    if (state >= 7 && state < 853443 && _0xf303x62 && CanUse4) {
        font = Render.AddFont('Verdana', 7, 800);
        Render.FilledRect((screen_size[0] / 2) - 285, y7, 570, 30, [0, 0, 0, alpha7_b]);
        Render.GradientRect((screen_size[0] / 2) - 285, y7 - 3, 570, 3, 0, [104, 106, 128, alpha7], [5, 30, 110, alpha7]);
        Render.StringCustom((screen_size[0] / 2) - 235, y7 + 9, 0, '[+]', [46, 246, 53, alpha7], font);
        Render.StringCustom((screen_size[0] / 2) - 215, y7 + 9, 0, ' Successfully loaded: Advanced Fakelag & DT | [v1.0] [beta] | Last Update September 2 2020 19:59:21', [255, 255, 255, alpha7], font);
        Render.String((screen_size[0] / 2) - 265, y7 + 8, 0, '!', [255, 255, 255, alpha7], 5)
    };
    if (state >= 7 && _0xf303x62) {
        ...
        Render.GradientRect((screen_size[0] / 2) - 245, y4 - 3, _0xf303x63, 3, 0, [104, 106, 128, alpha4], [5, 30, 110, alpha4]);
        Render.StringCustom((screen_size[0] / 2) - 200, y4 + 9, 0, '[>.<]', [246, 224, 23, alpha4], font);
        Render.StringCustom((screen_size[0] / 2) - 155, y4 + 9, 0, 'HVHSTARCORD BETA has finished setup. Welcome, ' + username + '.', [255, 255, 255, alpha4], font);
    ...
    if (Globals.Realtime() > time + 2 && state == 3 && _0xf303x62) {
        Cheat.PrintColor([46, 246, 53, 255], '[+] ');
        Cheat.PrintColor([255, 255, 255, 255], 'Successfully loaded: Miss Logger | [v1.0] [beta] | Last Update August 29 2020 22:07:30' + '\x0A');
        time = Globals.Realtime();
        state = 4
    };
    if (Globals.Realtime() > time + 2 && state == 4 && _0xf303x62) {
        Cheat.PrintColor([46, 246, 53, 255], '[+] ');
        Cheat.PrintColor([255, 255, 255, 255], 'Successfully loaded: Watermark | [v1.0] [beta] | Last Update August 29 2020 21:59:30' + '\x0A');
        time = Globals.Realtime();
        state = 5
    };
    if (Globals.Realtime() > time + 2 && state == 5 && _0xf303x62) {
        Cheat.PrintColor([46, 246, 53, 255], '[+] ');
        Cheat.PrintColor([255, 255, 255, 255], 'Successfully loaded: AntiAim & Indicators | [v1.0] [beta] | Last Update August 29 2020 22:07:30' + '\x0A');
        time = Globals.Realtime();
        state = 6
    };
    if (Globals.Realtime() > time + 2 && state == 3 && !_0xf303x62) {
    ...
    if (Globals.Realtime() > time + 2 && state == 6 && _0xf303x62) {
        Cheat.PrintColor([46, 246, 53, 255], '[+] ');
        Cheat.PrintColor([255, 255, 255, 255], 'Successfully loaded: Advanced Fakelag & DT | [v1.0] [beta] | Last Update September 2 2020 19:59:21' + '\x0A');
        time = Globals.Realtime();
        CanUse4 = true;
        state = 7
    };
    ...
    if (Globals.Realtime() > time + 2 && state == 7 && _0xf303x62) {
        ...
        Cheat.PrintColor([255, 255, 255, 255], ' HVHSTARCORD BETA has finished setup. Welcome, ' + username + '\x0A');
        time = Globals.Realtime();
        state = 8
    };
    if (Globals.Realtime() > time + 2 && state == 5 && _0xf303x62) {
...
function handle_visibility() {
    if (CanUse1) {
        ...
        if (UI.GetValue('Script items', 'Watermark') == 1 && CanUse2) {
            UI.SetEnabled('Script items', 'Color 1', true);
            UI.SetEnabled('Script items', 'Color 2', true)
        } else {
            UI.SetEnabled('Script items', 'Color 1', false);
            UI.SetEnabled('Script items', 'Color 2', false)
        };
        if (UI.GetValue('Script items', 'Enable AntiAim & Indicators') == 1 && CanUse3) {
            ...
            UI.SetEnabled('Script items', 'Molotov Circle', true);
            if (UI.GetValue('Script items', 'Molotov Circle') == 1) {
                UI.SetEnabled('Script items', 'Molly Color', true);
                UI.SetEnabled('Script items', 'Smoke Color', true)
            } else {
                UI.SetEnabled('Script items', 'Molly Color', false);
                UI.SetEnabled('Script items', 'Smoke Color', false)
            };
            ...
            UI.SetEnabled('Script items', 'Molly Color', false);
            UI.SetEnabled('Script items', 'Smoke Color', false);
            UI.SetEnabled('Script items', 'Molotov Circle', false)
        };
...
function on_render() {
    if (!World.GetServerString() && huesos < Globals.Realtime() + 1) {
        return
    };
    entities = Entity.GetEntities();
    color123 = UI.GetColor('Script items', 'Molly Color');
    if (color123[3] == 0) {
        color123 = [255, 0, 0, 255]
    };
    if (UI.GetValue('Script items', 'Molotov Circle') && CanUse3) {
        for (i = 0; i < entities['length']; i++) {
            world_pos = Entity.GetRenderOrigin(entities[i]);
            name = Entity.GetClassName(entities[i]);
            screen_pos = Render.WorldToScreen(world_pos);
            huy1 = Entity.GetProp(entities[i], 'CInferno', 'm_fireCount');
            if (name != 'CInferno') {
                continue
            };
            Render.String(screen_pos[0] + 1, screen_pos[1] + 1 - 50, 1, 'molly', [0, 0, 0, 255]);
            Render.String(screen_pos[0], screen_pos[1] - 50, 1, 'molly', [255, 255, 255, 255]);
            Render.Line(screen_pos[0] - 50, screen_pos[1] - 50, screen_pos[0] - 40, screen_pos[1] - 40, color123);
            Render.Line(screen_pos[0] - 40, screen_pos[1] - 50, screen_pos[0] - 50, screen_pos[1] - 40, color123);
            draw_circle1(world_pos[0], world_pos[1], world_pos[2], Math['sqrt'](huy1) * 50, 0.150, color123)
        }
    }
}
...
function on_render2() {
    ...
    entities = Entity.GetEntities();
    color321 = UI.GetColor('Script items', 'Smoke Color');
    if (UI.GetValue('Script items', 'Molotov Circle') && CanUse3) {
        if (color321[3] == 0) {
            color321 = [150, 150, 255, 255]
        };
        for (i = 0; i < entities['length']; i++) {
            world_pos = Entity.GetRenderOrigin(entities[i]);
            name = Entity.GetClassName(entities[i]);
            screen_pos = Render.WorldToScreen(world_pos);
            huy = Entity.GetProp(entities[i], 'CSmokeGrenadeProjectile', 'm_nSmokeEffectTickBegin');
            if (name != 'CSmokeGrenadeProjectile') {
                continue
            };
            if (huy != 0) {
                Render.String(screen_pos[0] + 1, screen_pos[1] + 1 - 50, 1, 'smoke', [0, 0, 0, 255])
            };
            if (huy != 0) {
                Render.String(screen_pos[0], screen_pos[1] - 50, 1, 'smoke', [255, 255, 255, 255])
            };
            if (huy != 0) {
                draw_circle1(world_pos[0], world_pos[1], world_pos[2], 140, 0.150, color321)
            }
        }
    }
}
...
function hitlog() {
    ...
    if (me == attackerIndex && me != victimIndex) {
        ...
        Cheat.PrintColor([238, 143, 36, 255], 'HVHSTAR');
        Cheat.PrintColor([198, 198, 198, 255], 'CORD');
        Cheat.PrintColor([255, 255, 255, 255], ']');
        ...
        if (_0xf303x8e == 'Hit ') {
            if (UI.GetValue('Script items', 'Enable chat logging')) {
                Cheat.PrintChat(' \x01[\x10HVHSTAR\x08CORD\x01][\x04' + shots.toString() + '\x08] ' + _0xf303x8e + name + '\'s 	' + HitgroupName(hitbox) + '\x08 for \x02' + target_damage.toString() + '\x08 (\x06' + target_health.toString() + '\x08 remaining) aimed=\x02' + hitboxName + '\x08(' + predicthc.toString() + '%%)\x08 (\x10' + _0xf303x90 + '\x08) (\x10' + _0xf303x8f + '\x08:\x10' + exploit + '\x08)\x0A')
            };
