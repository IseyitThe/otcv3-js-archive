...
UI.AddColorPicker("[SuicidEE.cf] Hitlog Color");

var color = UI.GetColor("MISC", "JAVASCRIPT", "Script Items", "[SuicidEE.cf] Hitlog Color");

if (color[0] === 0 && color[1] === 0 && color[2] === 0 && color[3] === 0){
    UI.SetColor("MISC", "JAVASCRIPT", "Script Items", "[SuicidEE.cf] Hitlog Color", [255, 0, 0, 255]);
}
...
function drawMultiColorText(x, y, lines) {
    ...
    for (var i = 0; i < lines.length; i++) {
        ...
        if (typeof line[0] == "number") {
            color = UI.GetColor("MISC", "JAVASCRIPT", "Script Items", "[SuicidEE.cf] Hitlog Color");
        }
