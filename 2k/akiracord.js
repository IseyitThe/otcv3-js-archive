...
function indicators() {
    ...
    if (CanUse3 && UI.GetValue('Script items', 'Enable Indicators') == 1 && UI.GetValue('Script items', 'Enable AntiAim & Indicators') == 1) {
        ...
        var _0xf303x48 = Render.TextSize('akira', 7);
        ...
        Render.String(screen_size[0] / 2 - _0xf303x48[0] / 2 + 2, screen_size[1] / 2 + 80 + _0xf303x48[1] / 2 + 2, 0, 'akira', [255, 236, 236, _0xf303x41], 7);
        Render.String(screen_size[0] / 2 - _0xf303x48[0] / 2 + 1, screen_size[1] / 2 + 80 + _0xf303x48[1] / 2 + 1, 0, 'akira', [255, 236, 236, _0xf303x40], 7);
        Render.String(screen_size[0] / 2 - _0xf303x48[0] / 2, screen_size[1] / 2 + 80 + _0xf303x48[1] / 2, 0, 'akira', [255, 236, 236, _0xf303x3f], 7);
        ...
        Render.String(screen_size[0] / 2 - _0xf303x4b[0] / 2 + 2, screen_size[1] / 2 + 120 + _0xf303x4b[1] / 2 + 2, 0, 'DT', _0xf303x42 ? _0xf303x43 == 1 ? [128, 255, 0, 55] : [255, 0, 0, _0xf303x41] : [255, 0, 0, _0xf303x41], 7);
        Render.String(screen_size[0] / 2 - _0xf303x4b[0] / 2 + 1, screen_size[1] / 2 + 120 + _0xf303x4b[1] / 2 + 1, 0, 'DT', _0xf303x42 ? _0xf303x43 == 1 ? [128, 255, 0, 155] : [255, 0, 0, _0xf303x40] : [255, 0, 0, _0xf303x40], 7);
        Render.String(screen_size[0] / 2 - _0xf303x4b[0] / 2, screen_size[1] / 2 + 120 + _0xf303x4b[1] / 2, 0, 'DT', _0xf303x42 ? _0xf303x43 == 1 ? [128, 255, 0, 255] : [255, 0, 0, _0xf303x3f] : [255, 0, 0, _0xf303x3f], 7);
...
function watermark() {
    ...
    var _0xf303x5d = 'akiracord | akira | delay: ' + _0xf303x5b + 'ms | ' + _0xf303x5a + 'tick | ' + _0xf303x57 + _0xf303x58 + _0xf303x59;
...
function authorization() {
    ...
    if (state >= 1) {
        ...
        Render.StringCustom((screen_size[0] / 2) - (width / 2) + 80, y + 9, 0, 'akira#1234', [255, 255, 255, alpha], font);
    ...
    if (state >= 2 && state < 4) {
        ...
        Render.StringCustom((screen_size[0] / 2) - 90, y1 + 9, 0, 'shoppy.gg/@hvhboss', [255, 255, 255, alpha1], font);
    ...
    if (state >= 3 && state < 7) {
        ...
        Render.StringCustom((screen_size[0] / 2) - 120, y2 + 9, 0, 'YouTube.com/hvhchampione', [255, 255, 255, alpha2], font);
    ...
    if (Globals.Realtime() > time + 2 && state == 7 && _0xf303x62) {
        ...
        Cheat.PrintColor([255, 255, 255, 255], ' akiracord has finished setup. Welcome, ' + username + '\x0A');
        time = Globals.Realtime();
        state = 8
    };
    if (Globals.Realtime() > time + 2 && state == 5 && _0xf303x62) {
...
function hitlog() {
    ...
    if (me == attackerIndex && me != victimIndex) {
        ...
        Cheat.PrintColor([238, 143, 36, 255], 'gamese');
        Cheat.PrintColor([198, 198, 198, 255], 'nse');
        Cheat.PrintColor([255, 255, 255, 255], ']');
        ...
        if (_0xf303x8e == 'Hit ') {
            if (UI.GetValue('Script items', 'Enable chat logging')) {
                Cheat.PrintChat(' \x01[\x10game\x08sense\x01][\x04' + shots.toString() + '\x08] ' + _0xf303x8e + name + '\'s 	' + HitgroupName(hitbox) + '\x08 for \x02' + target_damage.toString() + '\x08 (\x06' + target_health.toString() + '\x08 remaining) aimed=\x02' + hitboxName + '\x08(' + predicthc.toString() + '%%)\x08 (\x10' + _0xf303x90 + '\x08) (\x10' + _0xf303x8f + '\x08:\x10' + exploit + '\x08)\x0A')
            };
