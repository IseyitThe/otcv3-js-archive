//UI stuff here
UI.AddHotkey(["Config", "SUBTAB_MGR", "Scripts", "SHEET_MGR", "Keys", "JS Keybinds"], "Fake Duck MM", "");
var crouchHeight;

function FakeDuck() {
    var cmd = UserCMD.GetButtons();
    //If key is held do ducking
    if(UI.GetValue(["Config", "SUBTAB_MGR", "Scripts", "SHEET_MGR", "Keys", "JS Keybinds", "Fake Duck MM"])) {
