var prevVal =  0;
var nextVal =  1;
var lines   = 22; // Last case number + 1
...
function fsn() {
    ...
    var servertime = Math.floor((Globals.TickInterval() * tickbase) *2.2);
    ...
    switch(value){
        ...
        case 14: Local.SetClanTag(" gamesens ");break;
        case 15: Local.SetClanTag(" gamesen ");break;
        case 16: Local.SetClanTag(" gamese ");break;
        case 17: Local.SetClanTag(" games ");break;
        case 18: Local.SetClanTag(" game ");break;
        case 19: Local.SetClanTag(" gam ");break;
        case 20: Local.SetClanTag(" ga  ");break;
        case 21: Local.SetClanTag(" g ");break;
