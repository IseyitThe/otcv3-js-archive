...
function A1(){
	...
	yawnewoffset = randomIntFrom(-20, 15);
	
    UI.SetValue("Anti-Aim", "Rage Anti-Aim", "Yaw offset", yawnewoffset);
	UI.SetValue("Anti-Aim", "Fake angles", "Fake desync", false);
	UI.SetValue("Anti-Aim", "Fake angles", "LBY mode", 1,2);
	UI.SetValue("Anti-Aim", "Rage Anti-Aim", "At targets", true);
	UI.SetValue("Anti-Aim", "Fake angles", "Avoid overlap", true);
	
	// Fake Lag
	
	UI.SetValue("Anti-Aim", "Fake-Lag", "Limit", 10);
...
function A2(){
	...
	yawnewoffset = randomIntFrom(-27, 22);
	...
	UI.SetValue("Anti-Aim", "Fake-Lag", "Limit", 8);
...
function A3(){
	...
	yawnewoffset = randomIntFrom(-16, 5);
