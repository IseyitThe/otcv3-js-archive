    ...
    if(UI.GetValue( "Rage", "GENERAL", "Exploits", "Doubletap" ))
    {
        ...
        if(UI.IsHotkeyActive("Rage", "GENERAL", "Exploits", "Doubletap"))
        {
            ...
            if (curtime < delay)
            {
                ...
                if(fillbar > 60);
                Render.StringCustom(Global.GetScreenSize()[0]/49+UI.GetValue(Xoffset), Global.GetScreenSize()[1]-349+UI.GetValue(Yoffset), 1, "PORCTAP", [ 0, 0, 0, 255 ], font);
                Render.StringCustom(Global.GetScreenSize()[0]/50+UI.GetValue(Xoffset), Global.GetScreenSize()[1]-350+UI.GetValue(Yoffset), 1, "PORCTAP", [ 250, 92, 111, 255 ], font);
            }
            else
            {
                Render.StringCustom(Global.GetScreenSize()[0]/49+UI.GetValue(Xoffset), Global.GetScreenSize()[1]-349+UI.GetValue(Yoffset), 1, "PORCTAP", [ 0, 0, 0, 255 ], font);  
                Render.StringCustom(Global.GetScreenSize()[0]/50+UI.GetValue(Xoffset), Global.GetScreenSize()[1]-350+UI.GetValue(Yoffset), 1, "PORCTAP", [ 108, 192, 245, 255 ], font);  
        ...
        {
            //Disabled
            Render.StringCustom(Global.GetScreenSize()[0]/50+UI.GetValue(Xoffset), Global.GetScreenSize()[1]-350+UI.GetValue(Yoffset), 1, "PORCTAP", [ 69, 67, 68, 150 ], font);
        }  
    }  
}
...
function Main()
{
    ...
    UI.AddLabel("PORCTAP' modified by omi#7133");
