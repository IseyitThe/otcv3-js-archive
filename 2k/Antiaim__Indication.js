...
function drawString()
{
	...
	isOVHBX = UI.IsHotkeyActive("Rage", "General", "Force body aim"); //UI.IsHotkeyActive("Rage", "General config", "Hitbox override")
	...
	{
		Render.String(screen_size[0] /2 +5, screen_size[1] /2 +40, 0, "STATIC", [ 177, 151, 255, 255 ],3 );
	}
	...
	if(drawLeft)
	{
		...
		if (isSP) {
			add_y = add_y + 9;
			Render.String(screen_size[0] /2 +5, screen_size[1] /2 + add_y, 0, "SAFE", [ 124, 195, 13, 255 ] ,3 );
		}
		if (isOVHBX) {
			add_y = add_y + 9;
