UI.AddCheckbox("Use SPDIs anti-aim"); //Master switch
...
function menu_cb() {
    var enabled = UI.GetValue(scriptitems, "Use SPDIs_COOL anti-aim");
...
function aa_sys() {
    var enabled = UI.GetValue(scriptitems, "Use SPDIs_Custom anti-aim");
