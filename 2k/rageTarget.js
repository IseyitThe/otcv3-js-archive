...
function Dropdown(x, y, width, height, parent, title, list, visible) {
    this.x = x;
    this.y = y;
    this.width = width;
    this.height = height;
...
function Checkbox(x, y, width, height, parent, title, visible) {
    this.x = x;
    this.y = y;
    this.width = width;
    this.height = height;
...
function Slider(x, y, width, height, parent, title, min, max, value, visible) {
    this.x = x;
    this.y = y;
    this.width = width;
    this.height = height;
...
function setup_player(player) {
    if (!player.is_setup()) {
        var shots_slider = new Slider(0, 2, 150, 7, menu, "Hitbox after x shots", 0, 5, 0, true);
        var hitbox_dropdown = new Dropdown(0, 0, 150, 15, menu, "Hitbox after x shots", ["None", "All", "Head", "Body"], true);
        var priority_checkbox = new Checkbox(0, 0, 15, 15, menu, "Priority", true);
        var ignored_checkbox = new Checkbox(0, 0, 15, 15, menu, "Ignored", true);
        ...
        var hideshots_checkbox = new Checkbox(0, 0, 15, 15, menu, "Hide shots", true);
        var invert_checkbox = new Checkbox(0, 0, 15, 15, menu, "Invert AA", true);
