...
function indicators() {
    ...
    if (CanUse3 && UI.GetValue('Script items', 'Enable Indicators') == 1 && UI.GetValue('Script items', 'Enable AntiAim & Indicators') == 1) {
        ...
        var _0xf303x48 = Render.TextSize('STARCORD', 7);
        ...
        Render.String(screen_size[0] / 2 - _0xf303x48[0] / 2 + 2, screen_size[1] / 2 + 80 + _0xf303x48[1] / 2 + 2, 0, 'STARCORD', [255, 236, 236, _0xf303x41], 7);
        Render.String(screen_size[0] / 2 - _0xf303x48[0] / 2 + 1, screen_size[1] / 2 + 80 + _0xf303x48[1] / 2 + 1, 0, 'STARCORD', [255, 236, 236, _0xf303x40], 7);
        Render.String(screen_size[0] / 2 - _0xf303x48[0] / 2, screen_size[1] / 2 + 80 + _0xf303x48[1] / 2, 0, 'STARCORD', [255, 236, 236, _0xf303x3f], 7);
...
function watermark() {
    ...
    var _0xf303x5d = 'STARCORD [akane mod] | ' + Cheat.GetUsername() + ' | delay: ' + _0xf303x5b + 'ms | ' + _0xf303x5a + 'tick | ' + _0xf303x57 + _0xf303x58 + _0xf303x59;
