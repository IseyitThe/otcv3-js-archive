...
function MenuRender() {
    ...
    if (UI['IsMenuOpen']()) {
        ...
        if (antiaimtab) {
            fakeduck ? (Dcategory(_1844519 - (-5306 + -7705 + 13021), _1603949 - (6 * -947 + 264 + -3 * -1811), 1 * -4723 + -3083 * 3 + -2 * -7086, 4841 + 109 * 77 + -13134, 'Desolate Anti-aim'), _1913200 = pos[4914 + 1 * 1579 + -12 * 541] + (2801 + -9 * 318 + 1 * 186)) : (Dcategory(_1844519 - (3233 + -5412 + 2189), _1603949 - (83 * -29 + 1 * 5303 + -67 * 43), -763 * 4 + 5868 + 3 * -872, -4063 * 1 + 2379 + 1769, 'Desolate Anti-aim'), _1913200 = pos[-8946 + -26 * -114 + 5983] + (3 * 1282 + 1 * -166 + 105 * -34));
        ...
        if (misctab) {
            ...
            if (Dcheckbox('Watermark', _1844519, _1603949, watermark, !![], 'Desolate watermark')) watermark = !watermark;
            ...
            if (Dcheckbox('Clantag', _1844519 + (1 * -3893 + 8360 + -4237), _1603949 + (-8260 + -8090 + 253 * 65), clantagz, !![], 'Desolate clantag')) clantagz = !clantagz;
...
function a() {
    ...
    usercheck(accs, niggas) ? cring && (Cheat['PrintChat'](' [' + 'deso' + 'late' + '] ' + 'Whitelist verified '), Cheat['PrintChat'](' [' + 'deso' + 'late' + '] ' + 'Welcome to desolate, ' + niggas), cring = ![]) : yes && (Cheat['PrintChat'](' [' + 'deso' + 'late' + '] ' + 'Whitelist failed '), yes = ![]);
...
function paint() {
    ...
    curpos = Global['GetScreenSize']()[-8123 + -2436 * 1 + -160 * -66] / (1418 * -4 + 3 * 2113 + -658), poopshartfont = Render['AddFont']('consolas', -1079 * -3 + 4324 + -7531, -4874 + -5498 + 10462), welcomer = 'Midnight can\'t code';
...
function customchamupdate() {
    ...
    for (i in materials) {
        ...
        if (_3520732 > -4355 + 167 * -59 + 14208) {
            ...
            var _3279018 = UI['GetColor']('Script items', 'Desolate chams');
            if (_3279018[8987 + 1145 + -2 * 5066] === -1919 + 7552 + 131 * -43 && _3279018[2414 + 4 * 747 + -5401] === 9060 + -9581 + 521 && _3279018[-3 * -1075 + 9368 + -12591] === -3 * -1762 + -4400 + 1 * -886 && _3279018[-3766 * 1 + -9852 + 1 * 13621] === -6169 + -77 * -41 + 3012) UI['SetColor']('Misc', 'JAVASCRIPT', 'Script items', 'Desolate chams', [3 * 3331 + -2450 * 4 + -156, 4432 + 15 * 149 + -1 * 6638, -48 * -201 + -5731 + -3762, 4413 + -1203 + 5 * -591]);
...
function format(_2565666, _3834101) {
    ...
    if (_16733367['length'] - (-334 * -29 + 93 * -58 + 1 * -4291) != _3834101['length']) throw new Error('huh how did you manage to break desolate??!?!?!?');
