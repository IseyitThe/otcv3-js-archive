...
UI.AddColorPicker("[bosu] accent color");
UI.AddLabel("xane e gay | [Hade$]#4643");
...
function watermark() {
  ...
  var ip = World.GetServerString();
    var watermark_string = "skeet [beta] | " + username;
  ...
  Render.GradientRect(screensize[0] * 0.99 - string_size[0], 8, string_size[0] + 10, 23, 1, [56, 60, 67, 255], [56, 60, 67, 255]);
...
function keybinds() {
  ...
  if(UI.IsMenuOpen() == true) {
    Render.GradientRect(x, y, 200 + 10, 23, 1, [56, 60, 67, 255], [56, 60, 67, 255]);
