...
function indicator(){
        ...
        if (UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Direction Desync R/L") == true) {
            h.push("4");
        }
        ...
        if (UI.IsHotkeyActive("Anti-Aim", "Extra", "Slow walk")) {
            if (UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Slow Walk") == true)
            {
                h.push("7");
            }
        }
        ...
        for (index = 0; index < h.length; ++index) {
            ...
            if(h[index] == 1)
                {
                    ...
                    Render.String( x + 0, y - 83 - (index * distance), 0, "FAKE", [ color * 255 / 58, 255 - ( color * 255 / 58 ), 0, 255 ] , 4);
                }
            if(h[index] == 2)
                {
                    if( !Entity.GetLocalPlayer( ) || !Entity.IsAlive( Entity.GetLocalPlayer( ) ) || !Entity.IsValid( Entity.GetLocalPlayer( ) ) )
            ...
            if(h[index] == 10)
                {
                    Render.String( x, y - 83 - (index * distance), 0, "SAFEPOINT", [0, 0, 0, 255] , 4);
                    Render.String( x + 1, y - 83 - (index * distance), 0, "SAFEPOINT", [124, 195, 13, 255] , 4);
                }
            if(h[index] == 15)
                {
...
Global.PrintColor([186, 235, 52, 255], "\n\n[ByCat] Indicator Loaded! REMAKE by PiotreQ \n bycat.cf \n\n\n");
...
UI.AddCheckbox("Direction Desync R/L");
...
UI.AddCheckbox("HC");
UI.AddLabel("      Remake By PiotreQ#7968")
